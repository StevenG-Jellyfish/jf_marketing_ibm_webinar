...
var paths = {
    styles:  ['sass/**/*.scss'],                  
                                    //used for watch task
    criticalstyles : ['sass/_critical/**/*.scss'], 
                                    //used for criticalstyles task
    noncriticalstyles : ['sass/_noncritical/**/*.scss'], 
                                    //used for noncriticalstyles task
    
    /* Not needed for Jellyfish Webinar Series : IBM Webinar Site
    scripts: [ //'../../public_html//js/jquery/jquery.js',
               //
